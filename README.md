...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ku20w0e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ku20w0e.containers.anotherwebservice.com/
...
```
git clone git@github.com:vdtrix34-pixel/container-ku20w0e.git
cd container-ku20w0e
```
...
```
docker attach container-ku20w0e
```
